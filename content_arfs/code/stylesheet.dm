...
.centradio				{color: #00BB06; font-size: 3; font-weight: bold}
.airadio				{color: #FF00AD; font-size: 2}
.entradio				{color: #339966; font-size: 2}
...
.supradio				{color: #7E4E03; font-size: 2}
.srvradio				{color: #E70060; font-size: 2}
.expradio				{color: #555555; font-size: 2}
...
.attack					{color: #ff0000; font-weight: bold}
.moderate				{color: #CC0000;}
.disarm					{color: #FFAF00; font-weight: bold}
