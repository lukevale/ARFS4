...
///mob/living/simple_mob/pokemon/proc/update_icon()
//	if(lying || resting || sleeping)
//		icon_state = "[icon_state]_rest"
//	else
//		icon_state = "[icon_living]"

/mob/living/simple_mob/pokemon/New()
	..()
	verbs += /mob/living/simple_mob/pokemon/proc/simple_lay_down
...
/mob/living/simple_mob/pokemon/leg
...
/mob/living/simple_mob/pokemon/miltank/New()
	udder = new(50)
	udder.my_atom = src
	..()
...
/mob/living/simple_mob/pokemon/snorlax
	name = "snorlax"
	icon_state = "snorlax"
	icon_living = "snorlax"
	icon_dead = "snorlax_d"